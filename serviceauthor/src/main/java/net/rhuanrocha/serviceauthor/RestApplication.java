package net.rhuanrocha.serviceauthor;
...
@OpenAPIDefinition(info = @Info(
        title = "Cloud Conference Author Service",
        version = "1.0",
        description = "Service to Author",
        contact = @Contact(
                name="Rhuan Rocha",
...
public class RestApplication extends Application {
    ...
    private final String DB = "authors";

    @Inject
    @ConfigProperty(name = "author.mongo.host")
    private String host;
