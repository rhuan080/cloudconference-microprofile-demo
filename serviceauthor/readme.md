...
This will create an executable jar file **serviceauthor-wildfly.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/serviceauthor-wildfly.jar
